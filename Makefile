...
EXTRA_CFLAGS += -Wno-unused-variable -Wno-uninitialized -Wno-parentheses-equality -Wno-sometimes-uninitialized -Wno-tautological-pointer-compare -Wno-pointer-bool-conversion -Wno-self-assign
