...
{
	assert(initialized_);
	return exposure.count() / mode_.line_length.count();
}
				 ...
				 Duration maxFrameDuration) const
{
	 ...
	 */
	frameLengthMin = minFrameDuration.count() / mode_.line_length.count();
	frameLengthMax = maxFrameDuration.count() / mode_.line_length.count();
